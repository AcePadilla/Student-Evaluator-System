...
<body>
    <nav>
        ...
        <li><a href="teacherdashboard.php"><i class="fa-solid fa-chart-line" style="color: white;"></i>Dashboard</a></li>
        
        <li><a href="teacher_result.php"><i class="fa-solid fa-square-poll-vertical" style="color: white;"></i>Results</a></li>
...
session_start();
            ...
            if ($resultSubjects && $rowSubjects = $resultSubjects->fetch_assoc()) {
                ...
                echo "<a href='#.php'><i class='fa-solid fa-book-open' style='color: #ffffff;'></i> Total subjects: $totalSubjects</a>";
            } else {
            ...
            if ($resultStudents && $rowStudents = $resultStudents->fetch_assoc()) {
                ...
                echo "<a href='#'><i class='fa-solid fa-user-group' style='color: #ffffff;'></i> Total students: $totalStudents</a>";
            } else {
            ...
            if ($resultClasses && $rowClasses = $resultClasses->fetch_assoc()) {
                ...
                echo "<a href='#.php'><i class='fa-solid fa-chalkboard' style='color: #ffffff;'></i> Total Classes: $totalClasses</a>";
            } else {
